...
public class HorariosComboBox extends JComboBox<String> {
	
	
	public HorariosComboBox(){
		super();
		completarCombo();
	}
	
	private void completarCombo(){
		setModel(new DefaultComboBoxModel(new String[] {"Seleccione un horario","00:00", "00:30","01:00", "01:30","02:00", "02:30","03:00", "03:30",
